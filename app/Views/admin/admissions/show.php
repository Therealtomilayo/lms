                        ...
                        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 space-y-5">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 border-b border-slate-100 pb-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-12 h-12 rounded-xl bg-slate-100 border border-slate-200 overflow-hidden flex items-center justify-center flex-shrink-0">
                                        <?php if ($passport): ?>
                                            <img src="/files/<?= $passport->id ?>/download" alt="Passport Photo" class="w-full h-full object-cover">
                                        <?php else: ?>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    <!-- Birth Certificate -->
                                    <div class="p-3 rounded-xl border <?= $birthCert ? 'border-emerald-200 bg-emerald-50/40' : 'border-dashed border-slate-200 bg-slate-50' ?> flex items-center justify-between">
                                        <div class="flex items-center gap-2 truncate">
                                            <i data-lucide="file-text" class="w-4 h-4 <?= $birthCert ? 'text-emerald-600' : 'text-slate-400' ?> flex-shrink-0"></i>
                                            <div class="truncate">
                                                <div class="font-bold text-xs text-slate-800 truncate">Birth Certificate</div>
                                                <div class="text-[10px] text-slate-400 truncate"><?= $birthCert ? htmlspecialchars($birthCert->originalName, ENT_QUOTES, 'UTF-8') : 'Not uploaded' ?></div>
                                            </div>
                                        </div>
                                        <?php if ($birthCert): ?>
                                            <a href="/files/<?= $birthCert->id ?>/download" target="_blank" class="p-1.5 rounded-lg bg-white border border-slate-200 text-slate-700 hover:text-brand-600 hover:border-brand-500 transition shadow-xs flex-shrink-0" title="View Document">
                                    ...
                                    <!-- Passport Photograph -->
                                    <div class="p-3 rounded-xl border <?= $passport ? 'border-emerald-200 bg-emerald-50/40' : 'border-dashed border-slate-200 bg-slate-50' ?> flex items-center justify-between">
                                        <div class="flex items-center gap-2 truncate">
                                            <i data-lucide="image" class="w-4 h-4 <?= $passport ? 'text-emerald-600' : 'text-slate-400' ?> flex-shrink-0"></i>
                                            <div class="truncate">
                                                <div class="font-bold text-xs text-slate-800 truncate">Passport Photo</div>
                                                <div class="text-[10px] text-slate-400 truncate"><?= $passport ? htmlspecialchars($passport->originalName, ENT_QUOTES, 'UTF-8') : 'Not uploaded' ?></div>
                                            </div>
                                        </div>
                                        <?php if ($passport): ?>
                                            <a href="/files/<?= $passport->id ?>/download" target="_blank" class="p-1.5 rounded-lg bg-white border border-slate-200 text-slate-700 hover:text-brand-600 hover:border-brand-500 transition shadow-xs flex-shrink-0" title="View Photograph">
                                                <i data-lucide="external-link" class="w-3.5 h-3.5"></i>
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="p-3 rounded-xl border <?= $report ? 'border-emerald-200 bg-emerald-50/40' : 'border-dashed border-slate-200 bg-slate-50' ?> flex items-center justify-between">
                                        <div class="flex items-center gap-2 truncate">
                                            <i data-lucide="file-check" class="w-4 h-4 <?= $report ? 'text-emerald-600' : 'text-slate-400' ?> flex-shrink-0"></i>
                                            <div class="truncate">
                                                <div class="font-bold text-xs text-slate-800 truncate">Previous Report</div>
                                                <div class="text-[10px] text-slate-400 truncate"><?= $report ? htmlspecialchars($report->originalName, ENT_QUOTES, 'UTF-8') : 'Optional / None' ?></div>
                                            </div>
                                        </div>
                                        <?php if ($report): ?>
                                            <a href="/files/<?= $report->id ?>/download" target="_blank" class="p-1.5 rounded-lg bg-white border border-slate-200 text-slate-700 hover:text-brand-600 hover:border-brand-500 transition shadow-xs flex-shrink-0" title="View Report">
                                                <i data-lucide="external-link" class="w-3.5 h-3.5"></i>
                                            </a>
                                        <?php endif; ?>
                                    </div>
