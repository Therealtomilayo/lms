<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
        <div>
            <h1 class="text-xl font-bold text-slate-900">Broadcast Institutional Announcement</h1>
            <p class="text-sm text-slate-600 mt-1">Publish an official announcement to the school, a specific class, or a subject group.</p>
        </div>

        <form method="POST" action="/admin/announcements" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="scope" id="scopeSelect" onchange="toggleScopeInputs()" required class="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-brand-500 outline-none">
                            <option value="school">School-wide (All Students, Teachers, Parents)</option>
                            <option value="class">Target Class</option>
                            <option value="class_subject">Target Subject Group</option>
                        </select>
                    </div>
            ...
            <div>
                ...
                <input type="text" name="title" id="title" required placeholder="e.g., End of Term Examination Schedule Released"
            ...
            <div>
                ...
                <textarea name="body" id="body" rows="6" required placeholder="Type the full announcement message here..."
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="published_at" id="published_at" value="<?= date('Y-m-d\TH:i') ?>"
