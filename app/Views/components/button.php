...
$variantStyles = [
    ...
    'secondary' => 'bg-slate-100 hover:bg-slate-200 active:bg-slate-300 text-slate-800 border border-slate-300 focus:ring-brand-500 shadow-xs disabled:bg-slate-50 disabled:text-slate-400 disabled:border-slate-200 disabled:cursor-not-allowed',
    ...
    'danger' => 'bg-red-600 hover:bg-red-700 active:bg-red-800 text-white focus:ring-red-500 shadow-sm border border-transparent disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed'
];
