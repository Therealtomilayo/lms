...
<div class="form-group flex flex-col gap-1.5 w-full">
    ...
    <?php if ($type === 'password'): ?>
        <div class="relative w-full">
            ...
            >
            <button type="button" 
                    class="lms-password-toggle-btn absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-600 focus:outline-none cursor-pointer" 
