 ...
 * @var int|null $rows Textarea row count (default: 4)
 ...
 * @var string|null $class Custom CSS classes for textarea (default: empty)
...
$baseTextareaStyles = 'block w-full px-3.5 py-2.5 rounded-lg text-base text-slate-800 placeholder-slate-400 bg-white border shadow-xs transition duration-200 focus:outline-none focus:ring-2 resize-y';
...
$textareaClasses = $baseTextareaStyles . ' ' . (!empty($error) ? $errorStyles : $normalStyles) . ' ' . ($class ?? '');
?>
