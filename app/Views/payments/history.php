    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                <a href="/dashboard" class="hover:text-brand-600 transition">Dashboard</a>
                <span>&rsaquo;</span>
            ...
            <p class="text-xs text-slate-500 mt-1">Review all completed receipts, payment references, and scratch-card PIN allocations.</p>
        </div>
        <div>
                        ...
                        <?php foreach ($payments as $pay): ?>
                            <tr class="hover:bg-slate-50/80 transition">
                                ...
                                <td class="py-3.5 px-4">
                                    <span class="font-bold text-slate-900 block"><?= e($pay->metadata['item_description'] ?? 'Result Access Scratch-Card PIN') ?></span>
