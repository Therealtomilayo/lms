...
<section class="bg-brand-primary/5 px-5 lg:px-8 py-16 lg:py-24">
  <div class="mx-auto max-w-4xl">
    ...
    <ol class="relative border-l-2 border-brand-primary/25 pl-8 space-y-12">
      ...
      <li class="reveal relative">
        <span class="absolute -left-[41px] top-0 flex size-6 items-center justify-center rounded-full bg-brand-accent text-white"><i data-lucide="sparkles" class="size-3.5" aria-hidden="true"></i></span>
        <h3 class="font-serif text-xl font-bold text-brand-dark">Claret today</h3>
        <p class="mt-2 text-sm leading-6 text-slate-600">15+ years on, Claret is a co-educational day school known for its clubs, its tech-ready classrooms, and learners who are known, valued and inspired to make a difference.</p>
      </li>
    </ol>
  </div>
</section>
...
<section class="mx-auto max-w-7xl px-5 lg:px-8 py-16 lg:py-24">
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:auto-rows-[180px]">
    <div class="reveal-scale lift-hover md:col-span-2 md:row-span-2 rounded-3xl overflow-hidden"><img src="assets/img/hero-carousel.jpg" alt="Claret graduates throwing their caps in celebration" class="h-full w-full object-cover"></div>
    <div class="reveal-scale lift-hover rounded-3xl overflow-hidden"><img src="assets/img/hero-carousel.jpg" alt="Claret graduation ceremony stage" class="h-full w-full object-cover object-top"></div>
    <div class="reveal-scale lift-hover rounded-3xl overflow-hidden"><img src="assets/img/hero-carousel.jpg" alt="Claret learners in their graduation gowns" class="h-full w-full object-cover object-left"></div>
    <div class="reveal-scale lift-hover rounded-3xl overflow-hidden"><img src="assets/img/hero-carousel.jpg" alt="Claret learners holding certificates" class="h-full w-full object-cover object-right"></div>
    <div class="reveal-scale lift-hover rounded-3xl overflow-hidden"><img src="assets/img/hero-carousel.jpg" alt="Claret learners smiling with medals" class="h-full w-full object-cover object-bottom"></div>
  </div>
</section>
